  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ URL::to('dashboard') }}">
        ...
        <div class="sidebar-brand-text mx-3">MULTI RESTAURANTS</div>
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="{{ URL::to('dashboard') }}">
          ...
          <span>SUPER ADMIN DASHBOARD</span></a>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Manage Restaurants:</h6>
                     <a class="collapse-item" href="{{ URL::to('create-restaurant') }}"> Create Restaurant</a>
                <a class="collapse-item" href="{{ URL::to('all-restaurants') }}"> All Restaurants </a>
          </div>
        </div>
      </li>
        ...
        <div id="collapseSlider" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Custom Components:</h6>
                ...
                <a class="collapse-item" href="{{ URL::to('all-sliders') }}"> All Slider </a>
          </div>
        </div>
      </li>
-->
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="https://i.ibb.co/zFn5wmC/download.png">
              </a>
              <!-- Dropdown - User Information -->
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                
				
				<a class="dropdown-item" href="{{ URL::to('all-restaurants') }}"> 
				
                  <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                  Restaurants
                </a>
                <a class="dropdown-item"  href="{{ URL::to('all-categories') }}">
                  <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>
                  Categories
                </a>
                <a class="dropdown-item"  href="{{ URL::to('all-products') }}">
                  <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>
                  Products
                </a>
				
				<a class="dropdown-item"  href="{{ URL::to('all-orders') }}">
