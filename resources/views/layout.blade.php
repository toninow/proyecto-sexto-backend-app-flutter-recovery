    ...
    <ul class="sidebar navbar-nav">
		...
		<li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                ...
                <a class="dropdown-item" href="{{ URL::to('create-restaurant') }}"> Create Restaurant</a>
                <a class="dropdown-item" href="{{ URL::to('all-restaurants') }}"> All Restaurants </a>
		...
		<li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                ...
                <a class="dropdown-item" href="{{ URL::to('all-sliders') }}"> All Slider </a>
		...
		<li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                ...
                <a class="dropdown-item" href="{{ URL::to('all-orders') }}"> All Orders </a>
